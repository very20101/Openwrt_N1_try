...
rm -rf feeds/packages/libs/expat package/system/ubox package/libs/libcap package/libs/zlib
...
cp -rf package/openwrt_N1_test/extra_pack/libcap package/libs/libcap
